# Session Synthesis Instructions — MEDIUM

> **This is the MEDIUM weight synthesis file.** Use for sessions with 6-15 changes.
> For <6 changes use synthesis-light.md. For 16+ or every 5th session use synthesis-heavy.md.
