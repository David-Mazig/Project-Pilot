# Session Synthesis Instructions — HEAVY

> **This is the HEAVY weight synthesis file.** Use for sessions with 16+ changes or every 5th synthesis.
> For <6 changes use synthesis-light.md. For 6-15 changes use synthesis-medium.md.
